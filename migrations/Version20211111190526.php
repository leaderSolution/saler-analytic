 ...
 */
final class Version20211111190526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, address_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, cin VARCHAR(255) DEFAULT NULL, is_active BOOLEAN DEFAULT NULL, nb_visits_day INT DEFAULT NULL, turnover_target DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
